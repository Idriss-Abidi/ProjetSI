    ...
    <div>
      <Navbar fluid rounded className="m-auto w-[90%]">
        ...
        <Navbar.Collapse>
          ...
          {/* <Navbar.Link href={`/entreprise/${id_gest_entr}`}>Offres</Navbar.Link> */}
        ...
        <div className="hero bg-base-200 min-h-[400px]">
          <div className="hero-content flex-col md:flex-row-reverse">
            ...
            <div className="w-8/12 ml-[7%] min-h-[250px]">
              ...
              <button
                type="button"
                className="inline-flex items-center rounded-lg border-1 border-black px-2.5 py-1.5 text-center text-4xl font-Large text-dark hover:bg-gray-500 hover:text-dark-900"
              >
                Get started
